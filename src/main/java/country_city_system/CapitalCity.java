...
public class CapitalCity extends City{
    ...
    public CapitalCity(int id, String name, int population, boolean isCapital, double area, Country country, String governmentType, String mayorName, int parliamentMembers) {
